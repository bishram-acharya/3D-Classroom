...
void Window::drawWindow3() {
	...
	glColor3f(0.6f, 0.7333f, 1.0f);
	glBegin(GL_QUADS);
	glVertex3f(9.990f, 5.0f, 6.50f);
	glVertex3f(9.990f, 7.0f, 6.50f);
	glVertex3f(9.990f, 7.0f, 0.0f);
	glVertex3f(9.990f, 5.0f, 0.0f);
	glEnd();
...
void Window::drawWindow4() {
	...
	glColor3f(0.6f, 0.7333f, 1.0f);
	glBegin(GL_QUADS);
	glVertex3f(9.990f, 5.0f, 7.0f);
	glVertex3f(9.990f, 7.0f, 7.0f);
	glVertex3f(9.990f, 7.0f, 10.0f);
	glVertex3f(9.990f, 5.0f, 10.0f);
	glEnd();
...
void Window::drawWindow5() {
	...
	glColor3f(0.6f, 0.7333f, 1.0f);
	glBegin(GL_QUADS);
	glVertex3f(9.990f, 5.0f, -1.0f);
	glVertex3f(9.990f, 7.0f, -1.0f);
	glVertex3f(9.990f, 7.0f, -4.0f);
	glVertex3f(9.990f, 5.0f, -4.0f);
	glEnd();
