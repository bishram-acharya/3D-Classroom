...
void renderScene(void) {
	...
	//wall you see in front when you enter from door
	...
	//wall with door attached left portion
	glColor3f(0.9294f, 0.9216f, 0.8353f);
	glBegin(GL_QUADS);
	...
	glVertex3f(10.0f, 0.0f, 10.0f);
	glEnd();
	//wall with door attached right portion
	glColor3f(0.9294f, 0.9216f, 0.8353f);
	glBegin(GL_QUADS);
	glVertex3f(10.0f, 0.0f, -10.0f);
	glVertex3f(10.0f, 7.0f, -10.0f);
	...
	glEnd();
	//wall with door attached top portion
	glColor3f(0.9294f, 0.9216f, 0.8353f);
	glBegin(GL_QUADS);
	...
	glLineWidth(30.0f);
	glBegin(GL_LINES);
	glVertex3f(10.01f, 5.0f, -9.0f);
	glVertex3f(10.01f, 5.0f, -6.01f);
	glEnd();
	glBegin(GL_LINES);
	glVertex3f(10.01f, 5.0f, -9.01f);
	glVertex3f(10.01f, 0.0f, -9.01f);
	glEnd();

	glBegin(GL_LINES);
	glVertex3f(10.01f, 0.0f, -6.01f);
	glVertex3f(10.01f, 5.0f, -6.01f);
	glEnd();
	...
	if (x < -7.0 && x > -10.0 && z < -1.0 && z > -2.0) {
		interactWithSnowman();
	}

	//first fan positioning
	glPushMatrix();
	glTranslatef(-2.0f, 6.0f, -4.5f);
	glScalef(0.3f, 0.3f, 0.3f);
	f1.drawFan();
	glPopMatrix();
	//second fan position
	glPushMatrix();
	glTranslatef(4.0f, 6.0f, 6.0);
	glScalef(0.3f, 0.3f, 0.3f);
	f2.drawFan();
	glPopMatrix();
